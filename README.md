# IWA-Back-UtilisateursMS
Le microservice de gestion des utilsateurs du backend du projet IWA.
...
- Authentification et génération des tokens (JWT).
- Gestion des rôles des utilisateurs.
- Intégration avec le système de sécurité de l'API Gateway.
- Gestion des formules des utilisateurs (CRUD)
- Gestion des établissements des utilisateurs (CRUD)
